...
This package closes `T5R.5` by freezing the production campaign artefacts for `top-tier-nonqpu-gpu-20260306T211650Z-scf-20260306t211651z`.

## Contents
- `campaign/` — Full campaign snapshot copied from `data/dft_workflow/campaigns/top-tier-nonqpu-gpu-20260306T211650Z-scf-20260306t211651z`.
