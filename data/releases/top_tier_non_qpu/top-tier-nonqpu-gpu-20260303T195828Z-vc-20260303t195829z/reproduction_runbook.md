...
Run:
```bash
python scripts/dft/validate_production_outputs.py --campaign-id top-tier-nonqpu-gpu-20260303T195828Z-vc-20260303t195829z
```
...
- `label_efficiency_gain`: 0.9041666666666667
- `valid_candidates`: 23
- `completed_jobs`: 23
